...
| app_version_info | Dict | 集群所属的应用版本信息，格式为`{ "status_time":"2017-04-21T02:34:24Z", "upgrade_policy":[], "resource_kit":"ca-nx8rerlv", "version_id":"appv-70gegwmp", "name":" 1.0 - ZooKeeper 3.4.9" } `|


**Example**

下列返回结果为应用[ZooKeeper](http://appcenter.yiqiyun.net.cn/apps/app-tg3lbp0a?name=ZooKeeper)所创建的集群

_Example Request_:

```
https://api.yiqiyun.net.cn/iaas/?action=DescribeClusters
