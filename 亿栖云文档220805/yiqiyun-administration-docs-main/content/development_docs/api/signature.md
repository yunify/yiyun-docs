...
您需要先在控制台创建[API密钥](http://console.yiqiyun.net.cn/access_keys/)，获得 accesss_key_id 和 secret_access_key，这里我们假设
...
这里我们假设您的 API 执行设备为 广东 2 区 id 为 i-7lchv5u3 的云服务器：
...
```
https://api.yiqiyun.net.cn/iam/?access_key_id=0z7dO3oN03byx1CepBDTyl
