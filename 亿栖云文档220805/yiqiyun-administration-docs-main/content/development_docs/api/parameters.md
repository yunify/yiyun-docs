...
| **zone** | 区域 ID，当 API 请求是需要在某个具体的区域执行时，需要加上该参数。例如 zw2。 | 目前支持的区域 ID 有：<br/>zw2：行政服务域 |
...
>
>
> [https://api.yiqiyun.net.cn/iaas/?access_key_id=QYACCESSKEYIDEXAMPLE](https://api.yiqiyun.net.cn/iaas/?access_key_id=QYACCESSKEYIDEXAMPLE)
>
> &action=RunInstances
>
> &count=1
